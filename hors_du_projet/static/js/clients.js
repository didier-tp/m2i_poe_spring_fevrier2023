...
var traiterReponse = function(response) {
	...
	zoneResultat.innerHTML = jsClient.id + " " + jsClient.prenom + " " + jsClient.nom; //...
}
...
function onSearchClient() {
	...
	var urlWsGet = "http://localhost:8080/appliSpring/api-bank/client/" + numClient;
...
function doAjout(){
	...
	var url = "http://localhost:8080/appliSpring/api-bank/client"
...
function doLogin(){
	...
	var url = "http://localhost:8080/appliSpring/api-login/public/login"
